...
names(base) = new_names(base,"precipitação.*total","precipitacao_total")
names(base) = new_names(base,"pressao.*nivel","pressao_atm_nivel")
names(base) = new_names(base,"pressão.*max","pressao_atm_max")
names(base) = new_names(base,"pressão.*min","pressao_atm_min")
...
names(base) = new_names(base,"vento.*direção","vento_direcao")
